...
@SpringApplicationConfiguration(classes = YamlLoader.class)
...
//        }
        ...
        URL url = SynchronizerApplicationTests.class.getResource("repository-test1.yaml");
        properties.setProperty("ols.ontology.config", url.getPath());
        properties.setProperty("spring.data.mongodb.database","ols");
        properties.setProperty("ols.loader.filedir", "data");
        SpringApplication.run(YamlLoader.class);
