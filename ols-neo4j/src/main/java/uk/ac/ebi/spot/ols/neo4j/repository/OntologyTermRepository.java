...
public interface OntologyTermRepository extends Neo4jRepository<OlsTerm, Long> {
    ...
    Page<OlsTerm> getParents(String ontologyName, String iri, Pageable pageable);
    ...
    Page<OlsTerm> getHierarchicalParents(String ontologyName, String iri, Pageable pageable);

    @Query(
            countQuery = "MATCH (n:Class)-[:SUBCLASSOF|RelatedTree*]->(parent) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN count(distinct parent)",
            value = "MATCH (n:Class)-[:SUBCLASSOF|RelatedTree*]->(parent) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN distinct parent")
    Page<OlsTerm> getHierarchicalAncestors(String ontologyName, String iri, Pageable pageable);
    ...
    Page<OlsTerm> getChildren(String ontologyName, String iri, Pageable pageable);
    ...
    Page<OlsTerm> getHierarchicalChildren(String ontologyName, String iri, Pageable pageable);

    @Query( countQuery = "MATCH (n:Class)<-[:SUBCLASSOF|RelatedTree*]-(child) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN count(distinct child)",
            value = "MATCH (n:Class)<-[:SUBCLASSOF|RelatedTree*]-(child) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN distinct child")
    Page<OlsTerm> getHierarchicalDescendants(String ontologyName, String iri, Pageable pageable);


    @Query(countQuery = "MATCH (n:Class)<-[:SUBCLASSOF*]-(child) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN count(distinct child)",
            value = "MATCH (n:Class)<-[:SUBCLASSOF*]-(child) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN distinct child")
    Page<OlsTerm> getDescendants(String ontologyName, String iri, Pageable pageable);

    @Query(countQuery = "MATCH (n:Class)-[:SUBCLASSOF*]->(parent) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN count(distinct parent)",
                value = "MATCH (n:Class)-[:SUBCLASSOF*]->(parent) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN distinct parent")
    Page<OlsTerm> getAncestors(String ontologyName, String iri, Pageable pageable);
    ...
    Page<OlsTerm> getRelated(String ontologyName, String iri, String relation, Pageable pageable);

    @Query (value = "MATCH (n:Class) WHERE n.ontology_name = {0} AND n.iri = {1} RETURN n")
    OlsTerm findByOntologyAndIri(String ontologyName, String iri);

    @Query (countQuery = "MATCH (n:Class {ontology_name : {0}}) RETURN count(n)",
            value = "MATCH (n:Class {ontology_name : {0}}) RETURN n")
    Page<OlsTerm> findAllByOntology(String ontologyName, Pageable pageable);

    @Query (value = "MATCH (n:Class) WHERE n.ontology_name = {0} AND n.short_form = {1} RETURN n")
    OlsTerm findByOntologyAndShortForm(String ontologyId, String shortForm);

    @Query (value = "MATCH (n:Class) WHERE n.ontology_name = {0} AND n.obo_id = {1} RETURN n")
    OlsTerm findByOntologyAndOboId(String ontologyId, String oboId);
    ...
    Page<OlsTerm> getRoots(String ontologyId, boolean obsolete, Pageable pageable);
    ...
    Page<OlsTerm> getPreferredRootTerms(String ontologyId, boolean obsolete, Pageable pageable);
    ...
    Page<OlsTerm> findAll(Pageable pageable);
    ...
    Page<OlsTerm> findAllByIsDefiningOntology(Pageable pageable);

    @Query (countQuery = "MATCH (n:Class) WHERE n.iri = {0} RETURN count(n)",
            value = "MATCH (n:Class) WHERE n.iri = {0} RETURN n")
    Page<OlsTerm> findAllByIri(String iri, Pageable pageable);
    ...
    Page<OlsTerm> findAllByIriAndIsDefiningOntology(String iri, Pageable pageable);
    		
    @Query (countQuery = "MATCH (n:Class) WHERE n.short_form = {0} RETURN count(n)",
            value = "MATCH (n:Class) WHERE n.short_form = {0} RETURN n")
    Page<OlsTerm> findAllByShortForm(String shortForm, Pageable pageable);
    ...
    Page<OlsTerm> findAllByShortFormAndIsDefiningOntology(String shortForm, Pageable pageable);
    
    @Query (countQuery = "MATCH (n:Class) WHERE n.obo_id = {0} RETURN count(n)",
            value = "MATCH (n:Class) WHERE n.obo_id = {0} RETURN n")
    Page<OlsTerm> findAllByOboId(String oboId, Pageable pageable);
    ...
    Page<OlsTerm> findAllByOboIdAndIsDefiningOntology(String oboId, Pageable pageable);
    ...
    Page<OlsIndividual> getInstances(String ontologyId, String iri, Pageable pageable);
}
